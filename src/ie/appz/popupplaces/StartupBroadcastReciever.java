...
public class StartupBroadcastReciever extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		Log.i(this.getClass().toString(), "Startup Broadcast Recieved. Notification Service Disabled: "+settings.getBoolean(PlaceOpenHelper.SERVICE_DISABLED, false));
		if (!settings.getBoolean(PlaceOpenHelper.SERVICE_DISABLED, false)) {
			Log.i(this.getClass().toString(), "Starting PopupTrigger.");
